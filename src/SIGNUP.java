...
public class SIGNUP extends JFrame {
	...
	public SIGNUP() {
		...
		lblNewLabel.setBounds(10, 98, 107, 30);
		...
		fname.setBounds(125, 103, 139, 20);
		...
		lblNewLabel_3.setBounds(10, 265, 56, 30);
		...
		lblNewLabel_4.setBounds(337, 98, 66, 30);
		...
		btnNewButton.setBounds(97, 354, 89, 23);
		...
		btnNewButton_1.setBounds(263, 354, 89, 23);
		contentPane.add(btnNewButton_1);
		
		JSeparator separator = new JSeparator();
		separator.setBounds(0, 51, 661, 30);
		contentPane.add(separator);
		
		JLabel lblNewLabel_8 = new JLabel("SIGIN UP");
		lblNewLabel_8.setFont(new Font("Tahoma", Font.BOLD, 18));
		lblNewLabel_8.setBounds(252, 11, 268, 14);
		contentPane.add(lblNewLabel_8);
		
		JLabel lblNewLabel_9 = new JLabel("already registered member login");
		...
		lblNewLabel_9.setBounds(167, 422, 341, 14);
		contentPane.add(lblNewLabel_9);
		
		JButton btnExit = new JButton("Exit");
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				int a = JOptionPane.showConfirmDialog(btnExit, "Are you sure");
				if(a==JOptionPane.YES_OPTION)
				System.exit(0);
			}
		});
		btnExit.setBounds(440, 354, 89, 23);
		contentPane.add(btnExit);
		
		JLabel lblNewLabel_6 = new JLabel("USER NAME");
		lblNewLabel_6.setBounds(320, 221, 83, 14);
